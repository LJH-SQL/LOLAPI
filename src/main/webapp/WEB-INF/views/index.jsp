...
<jsp:include page="header.jsp"/>
        ...
        <header class="masthead bg-primary text-white text-center">
                ...
                <img style=width:20%;height:20%; src="resources/assets/img/logoCopy.png" alt="..." />
                <!-- Masthead Heading-->
               	<form name= "searchF" method="post" action="LOLAPI.search" onsubmit="name_check()">	
	                <div class="search">
	                	<input type="text" name="name" placeholder="사용자 이름" style=width:80%;></input>
		                <span class="input-group-btn">
		                    <button class="button button-ser" type="submit">검색</button>
		                </span>
	                </div>
                </form>
<!--  삭제대기
...
-->
        ...
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="TEST1">
            <div class="container">
                <!-- Portfolio Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">테스트</h2>
                <!-- Icon Divider-->
